                        ...
                        <div class="row">
                            <div class="col-md-8">
                                <div class="form-group">
                                    <label>Nama</label>
                                    <input type="text" class="form-control" name="lay_nama" required>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label>Urutan</label>
                                    <input type="text" class="form-control" name="lay_urutan" required>
                                </div>
                            </div>
                            <p></p>
                            <div class="col-md-12">
...
<script>
    $(document).ready(function () {
        ...
        $('#submitForm').click(function(e) {
            ...
            $.ajax({
                url: '<?= base_url('layanan/jenis/tambah/proses-tambah') ?>',
                type: 'POST',
                data: formData,
                processData: false, 
                contentType: false, 
