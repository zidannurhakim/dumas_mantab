...
<div class="container-fluid">
    ...
    <div class="card">
        <div class="card-body">
            <h4>Form <?= $title; ?></h4>
            <form action="<?= base_url('manajemen/level-user/proses-tambah'); ?>" enctype="multipart/form-data" method="post">
                <input type="hidden" name="<?= csrf_token(); ?>" value="<?= csrf_hash(); ?>">
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label>Nama</label>
                            <input type="text" name="usg_name" class="form-control">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label>Note/Catatan</label>
                            <input type="text" name="usg_note" class="form-control">
                        </div>
                    </div>
