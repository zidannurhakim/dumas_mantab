                ...
                <table class="container-email" role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                    ...
                    <tr>
                        <td class="content-email text-black">
                            ...
                            <p>Terima kasih telah menggunakan layanan DUMAS MAN 3 Banyuwangi. Data Anda telah kami terima dengan detail sebagai berikut:</p>
                            ...
                            <p>Kami akan segera memproses data Anda. Mohon bersabar dan periksa kembali email Anda secara berkala untuk pembaruan.</p>
                            ...
                            <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                                <tr>
                                    <td align="center">
                                        <a href="<?= base_url('/cek-data'); ?>" class="button-email" target="_blank">Cek Progress Data Anda Disini</a>
                                    </td>
                                </tr>
                            </table>
                        </td>
